<#
.SYNOPSIS
This script enables PowerShell Script Block Logging by setting the EnableScriptBlockLogging registry key to 1, creates the necessary registry path if it doesn't exist, forces a Group Policy update to apply the changes, and then verifies the updated configuration..NOTES
